db = connect( 'mongodb://localhost/LibraryDB' );
...
db.authors.insertMany([ { _id: 1, name: "George Orwell", nationality: "British", birth_year: 1903, death_year: 1950 }, 
...
db.book.find({name:"To Kill a Mockingbird"});
...
db.books.updateOne({ _id: 8 }, { $addToSet: { genres: "Novel" } });
